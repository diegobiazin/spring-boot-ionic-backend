...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.diegobiazin.cursomc.resources"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo(
                ...
                "Versão 1.0",
                "termos de uso",
                new Contact("Diego Biazin", "https://www.linkedin.com/in/diego-biazin-07a35766/", "diego.biazinns@gmail.com"),
